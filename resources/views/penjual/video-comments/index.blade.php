...
@section('title', 'Komentar Video Saya - Penjual')
...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        <h2 class="fw-bold mb-1">
            <i class="fas fa-comments text-primary me-2"></i>Komentar Video
        </h2>
        <p class="text-muted mb-0">Moderasi komentar di video produk Anda</p>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-0">
            @if($comments->count() > 0)
                <form id="bulkDeleteForm" method="POST" action="{{ route('penjual.video-comments.bulk-destroy') }}">
                    @csrf
                    @method('DELETE')
                                ...
                                @foreach($comments as $comment)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('penjual.video-comments.destroy', $comment->id) }}"
                                                  method="POST"
