...
@section('title', 'Edit Voucher - Admin Cosmetiqu')
@section('content')
<div class="mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit: {{ $voucher->code }}</li>
        </ol>
    </nav>
    <h2><i class="fas fa-edit"></i> Edit Voucher: {{ $voucher->code }}</h2>
</div>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $voucher->code) }}" required style="text-transform: uppercase;">
                        @error('code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="value" class="form-control @error('value') is-invalid @enderror" value="{{ old('value', $voucher->value) }}" required min="0" step="0.01">
                                @error('value')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted" id="valueHint">
                                    {{ $voucher->type === 'percentage' ? 'Contoh: 10 untuk 10%' : 'Contoh: 50000 untuk Rp 50.000' }}
                                </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="min_purchase" class="form-control @error('min_purchase') is-invalid @enderror" value="{{ old('min_purchase', $voucher->min_purchase) }}" required min="0" step="1000">
                                @error('min_purchase')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="max_discount" class="form-control @error('max_discount') is-invalid @enderror" value="{{ old('max_discount', $voucher->max_discount) }}" min="0" step="1000">
                                @error('max_discount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="usage_per_user" class="form-control @error('usage_per_user') is-invalid @enderror" value="{{ old('usage_per_user', $voucher->usage_per_user) }}" required min="1">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm mb-3 sticky-top" style="top: 20px;">
                <div class="card-header bg-primary text-white py-3">
                    <h5 class="mb-0 fw-bold"><i class="fas fa-save me-2"></i>Update Voucher</h5>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <p class="mb-2"><strong>Total Penggunaan:</strong> {{ $voucher->usages->count() }}</p>
                    <p class="mb-0"><strong>Status:</strong> <span class="badge bg-{{ $voucher->status_badge }}">{{ $voucher->status_text }}</span></p>
                </div>
            </div>
        </div>
    </div>
